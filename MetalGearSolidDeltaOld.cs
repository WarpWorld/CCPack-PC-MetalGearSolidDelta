...
namespace CrowdControl.Games.Packs.MetalGearSolidDeltaOld;

[SuppressMessage("ReSharper", "StringLiteralTypo")]
public class MetalGearSolidDeltaOld : InjectEffectPack
{
    public override Game Game { get; } = new("Metal Gear Solid Delta: Snake Eater", "MetalGearSolidDeltaOld", "PC", ConnectorType.PCConnector);

    public MetalGearSolidDeltaOld(UserRecord player, Func<CrowdControlBlock, bool> responseHandler, Action<object> statusUpdateHandler)
    ...
    private bool IsCamoIndexInstructionNormal()
    {
        try
        {
            byte[] patchedInstruction1 = new byte[] { 0x8B, 0x05, 0xE2, 0x5B, 0x8B, 0x0B };
            byte[] patchedInstruction2 = new byte[] { 0x8B, 0x05, 0x59, 0xC6, 0xB0, 0x0B };
